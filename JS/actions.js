...
async function checkSaveLoginInfoNoti(driver) {
  ...
  let notNow = await driver
    .findElement(By.xpath("/html/body/div[1]/section/main/div/div/div/button"))
    .then(
      function (webElement) {
        webElement.click();
        return true;
...
async function addInstaToHomeScreen(driver) {
  ...
  let cancel = await driver
    .findElement(By.xpath("/html/body/div[4]/div/div/div/div/div[3]/button[2]"))
    .then(
      function (webElement) {
        webElement.click();
        return true;
...
async function turnOnNotificaiton(driver) {
  await driver.sleep(getRandomFloat(2000, 3500));
  let cancel = await driver
    .findElement(By.xpath("/html/body/div[5]/div/div/div/div/div[3]/button[2]"))
    .then(
      function (webElement) {
        webElement.click();
        return true;
